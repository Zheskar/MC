...
namespace ManaCena.Models
{
    ...
    public partial class ManaCenaEntities : DbContext
    {
        public ManaCenaEntities()
            : base("name=ManaCenaEntities")
        {
        }
        ...
        public virtual DbSet<SubCathegory> SubCathegories { get; set; }
    }
}
